...
template <typename V>
PHYSFS_sint64 PHYSFSX_check_read(PHYSFS_file *file __attribute_unused, exact_type<V> v __attribute_unused, PHYSFS_uint32 S __attribute_unused, PHYSFS_uint32 C __attribute_unused) DXX_CXX11_EXPLICIT_DELETE;
template <typename V>
PHYSFS_sint64 PHYSFSX_check_write(PHYSFS_file *file __attribute_unused, exact_type<V> v __attribute_unused, PHYSFS_uint32 S __attribute_unused, PHYSFS_uint32 C __attribute_unused) DXX_CXX11_EXPLICIT_DELETE;

template <typename V>
PHYSFS_sint64 PHYSFSX_check_read(PHYSFS_file *file __attribute_unused, V **v __attribute_unused, PHYSFS_uint32 S __attribute_unused, PHYSFS_uint32 C __attribute_unused) DXX_CXX11_EXPLICIT_DELETE;
template <typename V>
PHYSFS_sint64 PHYSFSX_check_write(PHYSFS_file *file __attribute_unused, V **v __attribute_unused, PHYSFS_uint32 S __attribute_unused, PHYSFS_uint32 C __attribute_unused) DXX_CXX11_EXPLICIT_DELETE;
